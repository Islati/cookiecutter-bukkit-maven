...
class CookieCutterBukkitMaven(TemplateRenderPlugin):
    def __init__(self):
        super(CookieCutterBukkitMaven, self).__init__(
            name="cookiecutter_bukkit_maven_template_render",
            template_name="Bukkit_Plugin", version="1",
            description="Template Render plugin used to generate Bukkit Plugins to be built with Maven"
        )
    ...
    def perform(self, **kwargs):
        ...
        plugin_dependencies = click.prompt("Plugin Dependencies (Comma Separated)", default="")
...
cookiecutter_bukkit_maven_template_renderer = CookieCutterBukkitMaven()
